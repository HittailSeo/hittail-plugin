=== Long Tail Keyword Suggestions by HitTail ===
Contributors: hittailseo
Donate link: http://www.hittail.com/plans
...
1. Upload the `longtail-keyword-suggestions` folder to the `/wp-content/plugins/` directory
2. Activate the **Long Tail Keyword Suggestions by HitTail** plugin through the 'Plugins' menu in WordPress
